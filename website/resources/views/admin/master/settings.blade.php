...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div>
                    <ul class="nav nav-tabs bg-white mb-4" style="padding: 1rem">
                        <?php $tab = 1;
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="card box">
                                                    <?php if ($group_name != "" && $group_name != null) { ?>
                                                        <div class="card-header">
                                                            <div class="card-title">{{trans('view_pages.'.$group_name)}}</div>
                                                        </div>
                                                    <?php } ?>
                                                            ...
                                                            foreach ($group_value as $setting_name) { ?>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php } /*checkbox box*/ elseif ($setting_name['field'] == "checkbox") { ?>

                                                                        <?php } /*radio box */ elseif ($setting_name['field'] == "radio") { ?>

                                                                        <?php } /*text area  */ elseif ($setting_name['field'] == "textarea") { ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group text-right m-b-0">
                                                <button class="btn btn-custom btn-primary waves-effect waves-light" type="submit">
