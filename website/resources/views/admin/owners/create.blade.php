                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            ...
                                            <div class="tab-pane" id="owner-details">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            <label for="owner_name">@lang('view_pages.company_owner_name') <span
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="service_location_id" id="service_location_id" class="form-control" readonly>
                                                                ...
                                                                <option value="{{ $area->id }}" {{ old(
                                                                'service_location_id') == $area->id ? 'selected' : '' }}>{{ $area->name }}</option>
                                                                {{-- @endforeach --}}
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <ul class="admin-add-btn">
                                                            <li>
                                                                <button type="submit"
                                                                        class="btn btn-primary mr-1 waves-effect waves-light">{{ trans('view_pages.create') }}
                                                                </button>
                                                            </li>
                                                        </ul>
                                                    </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAly0S-jbb1aVNCAYtXrRRybxZUM8Z5CVo8&libraries=places&callback=initMap" async defer></script>
@endsection
