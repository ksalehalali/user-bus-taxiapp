...
class FleetNeededDocumentController extends BaseController
{
    ...
    {
        $page = trans('pages_names.add_vehicle_needed_doc');
    ...
    public function store(Request $request)
    {
        ...
        $message = trans('succes_messages.vehicle_needed_doc_added_succesfully');
    ...
    public function update(Request $request, FleetNeededDocument $neededDoc)
    {
        ...
        $message = trans('succes_messages.vehicle_needed_doc_updated_succesfully');
    ...
    public function toggleStatus(FleetNeededDocument $neededDoc)
    {
        ...
        $message = trans('succes_messages.vehicle_needed_doc_status_changed_succesfully');
        return redirect('fleet_needed_doc')->with('success', $message);
    }
    ...
    public function delete(FleetNeededDocument $neededDoc)
    {
        ...
        $message = trans('succes_messages.vehicle_needed_doc_deleted_succesfully');
        return redirect('fleet_needed_doc')->with('success', $message);
    }
}
