              ...
              return Directionality(
                ...
                child: Scaffold(
                  ...
                  appBar: PreferredSize(
                    preferredSize: _bottom == 0 ? Size.fromHeight(0) : Size.fromHeight(65.0),
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            SizedBox(width: media.width * 0.075),
                            Text('${languages[choosenLanguage]['txt_select_destination']}', style: TextStyle(color: white, fontSize: 20.0, fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Positioned(
                                    top: 0,
                                    child: Container(
                                        height: media.height * 1, width: media.width * 1,
                                        alignment: Alignment.center,
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            AnimatedContainer(
                                              ...
                                              padding: EdgeInsets.fromLTRB(media.width * 0.03, media.width * 0.01, media.width * 0.03, media.width * 0.01),
                                              ...
                                              border: Border.all(color: (_bottom == 0) ? page : light_grey.withOpacity(0.5), width: (_bottom == 0) ? 0 : 1),
                                              // border: Border.all(color: (_bottom == 0) ? page : Colors.grey, width: (_bottom == 0) ? 0 : 1),
                                              color: (_pickaddress == true && _bottom == 1) ? Colors.grey[300] : page,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    SizedBox(
                                                      ...
                                                      child: Text(
                                                        (addressList.where((element) => element.id == 'pickup').isNotEmpty)
                                                  ...
                                                  (_dropaddress == true && _bottom == 1)
                                                    ...
                                                    child: TextField(
                                                        ...
                                                        decoration: InputDecoration(
                                                            ...
                                                            border: InputBorder.none,
                                                            hintText: languages[choosenLanguage]['text_4lettersforautofill'],
                                                            hintStyle: GoogleFonts.roboto(fontSize: media.width * fifteen,
                                                                color: hintColor)),
                                                        maxLines: 1,
                                                        onChanged: (val) {
                                                          if (val.length >= 3) {
