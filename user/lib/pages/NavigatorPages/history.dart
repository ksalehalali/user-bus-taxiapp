              ...
              return Directionality(
                ...
                child: Scaffold(
                  appBar: PreferredSize(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: media.width * 0.030),
                          Text('${languages[choosenLanguage]['text_enable_history']}', style: TextStyle(color: white, fontSize: 24.0, fontWeight: FontWeight.w500),textAlign: TextAlign.center,),
                          Image.asset('assets/animated_images/app_bar_arrow.png', width: 100, height: 100, fit: BoxFit.fitHeight,),
                        ],
                      ),
                    ),
                    // child: AppBar(
                    ...
                    //     title: Text('${languages[choosenLanguage]['txt_select_destination']}', style: TextStyle(color: white, fontSize: 24.0),),
                    //     centerTitle: true,
                    //     actions: [
                    //       Image.asset('assets/animated_images/app_bar_arrow.png', width: 100, height: 100, fit: BoxFit.fitHeight,),
                    //     ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: light_grey.withOpacity(0.3)),
                                  boxShadow: [
                                    BoxShadow(
                                        blurRadius: 2,
                                        spreadRadius: 2,
                                        color: light_grey.withOpacity(0.4))
                                  ]
                              ),
                              child: Row(
                                children: [
                                  ...
                                  (myHistory.isNotEmpty)
                                      ? Column(
                                          children: myHistory
                                              .asMap()
                                              .map((i, value) {
                                                return MapEntry(i, (_showHistory == 1)
                                                        ?
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child: Container(
                                                                  decoration: BoxDecoration(
                                                                      ...
                                                                      border: Border.all(color: light_grey.withOpacity(0.1)),
                                                                      color: page,
                                                                      boxShadow: [
                                                                        BoxShadow(
                                                                            blurRadius: 2,
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Material(
                                                                              ...
                                                                              shape: RoundedRectangleBorder(
                                                                                ...
                                                                                side: BorderSide(color: light_grey.withOpacity(0.1))
                                                                              ),
                                                                              child: Container(
                                                                                ...
                                                                                child: IntrinsicHeight(
                                                                                  child: Row(
                                                                                    ...
                                                                                    children: [
                                                                                        ...
                                                                                        child: Row(
                                                                                          children: [
                                                                                            Container(
                                                                                                ...
                                                                                                child: CircleAvatar(backgroundImage: NetworkImage(myHistory[i]['driverDetail']['data']['profile_picture']),)),
                                                                                            // Container(
                                                                                            //   height:
                                                                                            //   media.width * 0.16,
                                                                                            //   width:
                                                                                                  ...
                                                                                                  children: [
                                                                                                    ...
                                                                                                    Text(
                                                                                                      (myHistory[i]['payment_opt'] == '1')
                                                                                                          ...
                                                                                                          : '',
                                                                                                      style: GoogleFonts.roboto(fontSize: media.width * fifteen, fontWeight: FontWeight.w600, color: light_grey),
                                                                                                    ),
                                                                                                  ],
                                                                                                ),
                                                                                              ],
                                                                                      ...
                                                                                      VerticalDivider(color: light_grey.withOpacity(0.3), thickness: 1.0,),
                                                                                      Expanded(
                                                                                        flex: 1,
                                                                                        child:
                                                                                            Column(
                                                                                                ...
                                                                                                Row(
                                                                                                  children: [
                                                                                                    Text(
                                                                                                      ...
                                                                                                      style: GoogleFonts.roboto(fontSize: media.width * twelve, color: light_grey),
                                                                                                    ),
                                                                                                  ],
                                                                                                )
                                                                                              ],
                                                                                      ...
                                                                                      children: [
                                                                                        SizedBox(
                                                                                          ...
                                                                                          child: Text(
                                                                                            ...
                                                                                            style: GoogleFonts.roboto(fontSize: media.width * fifteen),
                                                                                          ),
                                                                                        ),
                                                                                        Text(
                                                                                          '${myHistory[i]['trip_start_time'].toString().split(' ').toList()[2]} ${myHistory[i]['accepted_at'].toString().split(' ').toList()[3]}',
                                                                                          style: GoogleFonts.roboto(fontSize: media.width * fifteen, color: const Color(0xff898989)),
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                InkWell(
                                                                                  ...
                                                                                  child: Text(
                                                                                    ...
                                                                                    style: GoogleFonts.roboto(fontSize: media.width * sixteen, fontWeight: FontWeight.w600, color: primaryColor),
                                                                                  ),
                                                                                ),
                                                                              ],
                                                                            ),
